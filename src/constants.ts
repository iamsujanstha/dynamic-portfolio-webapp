...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A sophisticated analytics platform driven by neural networks, featuring real-time data visualization and predictive modeling.',
    tags: ['React', 'TypeScript', 'D3.js', 'PyTorch'],
    category: 'ai',
  ...
  },
  {
    ...
    description: 'Smart home ecosystem hub with low-latency device control and energy efficiency monitoring via sleek interfaces.',
    tags: ['React Native', 'Socket.io', 'Node.js', 'Framer Motion'],
    category: 'mobile',
  ...
  },
  {
    ...
    description: 'A high-performance graph-based CMS designed for massive scale and intuitive content modeling for growing enterprises.',
    tags: ['Next.js', 'PostgreSQL', 'Redis', 'GraphQL'],
    category: 'web',
    image: 'https://images.unsplash.com/photo-1635339001026-682911a8193a?q=80&w=1630&auto=format&fit=crop',
    link: '#',
    github: '#',
  },
  {
    ...
    description: 'An open-source design system architecture focused on accessibility, modularity, and rapid prototyping capabilities.',
    tags: ['Storybook', 'Tailwind', 'Figma', 'Radix UI'],
    category: 'design',
